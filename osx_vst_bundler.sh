...
if [[ -z $1 || -z $2 ]]; then
    ...
    mkdir -p "plugins/$1.vst/Contents/MacOS"

    # Create the PkgInfo
    echo "BNDL????" > "plugins/$1.vst/Contents/PkgInfo"
...
</plist>" > "plugins/$1.vst/Contents/Info.plist"

    # move the provided library to the correct location
    cp "$2" "plugins/$1.vst/Contents/MacOS/$1"

    echo "Created bundle plugins/$1.vst"
fi
